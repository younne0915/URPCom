...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class PostProcessPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            UnityEngine.Debug.LogError("post execute");

            if (m_IsFinalPass)
            {
                UnityEngine.Debug.LogError("m_IsFinalPass");
            ...
            {
                UnityEngine.Debug.LogError("CanRunOnTile");
            ...
            else
            {
                ...
                //UnityEngine.Debug.LogError("execute post-process");
                UnityEngine.Debug.LogError("post-process");
        ...
        {
            UnityEngine.Debug.LogError("Render");
            ...
            if (m_MotionBlur.IsActive() && !cameraData.isSceneViewCamera)
            {
                ...
                {
                    UnityEngine.Debug.LogError("Motion Blur");
